...
def loaded_model():
    ...
    json_file = open('/home/yang/LSTM-chemical-project/new-version-rnn/model/model.json', 'r')
    ...
    loaded_model.load_weights('/home/yang/LSTM-chemical-project/new-version-rnn/model/model.h5')
