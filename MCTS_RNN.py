...
if __name__ == "__main__":
    ...
    print val
    logP_values = np.loadtxt('/home/yang/grammarVAE/molecule_optimization/latent_features_and_targets_character/logP_values.txt')
    SA_scores = np.loadtxt('/home/yang/grammarVAE/molecule_optimization/latent_features_and_targets_character/SA_scores.txt')
    cycle_scores = np.loadtxt('/home/yang/grammarVAE/molecule_optimization/latent_features_and_targets_character/cycle_scores.txt')
